...
*********************************************************************
Name: MySQL Sample Database sales
...
/*CREATE DATABASE /*!32312 IF NOT EXISTS `sales` !40100 DEFAULT CHARACTER SET utf8mb3 */;
...
select count(*) from `orderdetails` LIMIT 1000; 
